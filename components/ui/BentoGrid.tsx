  ...
  return (
    ...
    >
        ...
        <div className="absolute size-full">
          {img && (
            <img
              src={img}
              alt={img}
              className={cn(imgClassName, "object-cover object-right")}
            />
          )}
        </div>
      </div>
      ...
      >
        ...
        {/* <div className="z-10 font-sans text-sm font-extralight text-[#C1C2D3] md:max-w-32 md:text-xs lg:max-w-48 lg:text-base">
          {description}
        </div> */}
      </div>
    </div>
